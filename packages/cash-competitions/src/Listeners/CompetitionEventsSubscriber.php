...
use App\Events\AfterUserTradeClose;
...
{
    public function afterUserTradeClose(AfterUserTradeClose $event) {
    ...
    {
        $events->listen(
            AfterUserTradeClose::class,
            'Packages\CashCompetitions\Listeners\CompetitionEventsSubscriber@afterUserTradeClose'
        );
