<div class="ui stackable grid container">
    <div class="column">
        <div class="ui labels">
            ...
            {{-- subhani code --}}
            <span class="ui {{ $settings->color }} basic label"><i class="money bill alternate outline icon"></i>{{ __('app.start_balance') }} {{ auth()->user()->account->balance }} {{ $competition->currency->code }}</span>
            {{-- subhani code --}}
            {{-- old code --}}
